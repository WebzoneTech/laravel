            ...
            <div class="business-add col-md-12 col-sm-12">
                  ...
                  <div class="adding-new-bussines col-md-12 col-sm-12">
                    ...
                    <div class="form-elements col-md-8 col-sm-12">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="form-field-1" value="" class="textcls" name="username" placeholder="Name">
                        </div>
                      ...
                      <div class="form-elements col-md-8 col-sm-12">
                        ...
                        <div class="col-sm-9">
                          <input value="" type="text" class="textcls" name="companyphonenumber" maxlength = "8" placeholder="Phone Number" onkeypress='ValidateNumber(event)'>
                        </div>
                      </div>
