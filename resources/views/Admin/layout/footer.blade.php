				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Qabuss</span>
...
function myMap() {
  ...
  var myCenter = new google.maps.LatLng(25.282235608688612,51.53147020771485); 
  var mapOptions = {center: myCenter, zoom: 12};
  var map = new google.maps.Map(mapCanvas,mapOptions);
  var marker = new google.maps.Marker({
    position: new google.maps.LatLng(25.282235608688612,51.53147020771485),
	draggable: true
  });
  marker.setMap(map);
...
google.maps.event.addListener(marker, 'dragend', function(evt){
    document.getElementById('current').innerHTML = '<p>Success: Current Lat: ' + evt.latLng.lat().toFixed(3) + ' Current Lng: ' + evt.latLng.lng().toFixed(3) + '</p>';
...
function setLoc(){
	...
	var lat = google.maps.event.latLng.lat();
	alert(lat);
	
}
</script>

<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAW-6i-zxt63vQBuvxwx3LkkPYDi7Mka-U&callback=myMap"></script>
